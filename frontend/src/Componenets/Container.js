  ...
  return (
    <div>
      <div className="container" data-aos="fade-up">
        <img className="container-img" src="img/trans.png" alt="Container 1" />
      ...
      <div className="container2" data-aos="fade-up">
        ...
        <img className="container-img" src="img/trans.png" alt="Container 2" />
      </div>
      ...
      <div className="container" data-aos="fade-up">
        <img className="container-img" src="img/trans.png" alt="Container 3" />
        <div className="description">
      ...
      <div className="bottom-container" data-aos="fade-up">
        ...
        <img src="img/trans.png" alt="Container 4" />
      </div>
